...
function bst_enqueues() {
	...
	wp_enqueue_style('bootstrap-css');
  	...
  	wp_register_style('owl-css', get_template_directory_uri() . '/css/owl.carousel.css', false, null);
	...
	/*Custom styles*/
	wp_register_style('custom-css', get_template_directory_uri() . '/css/styles.css', false, null);
